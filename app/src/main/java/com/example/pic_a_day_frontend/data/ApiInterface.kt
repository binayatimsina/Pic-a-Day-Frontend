...
import com.example.pic_a_day_frontend.User.SavedUserDataResponse
...
interface ApiInterface {
    ...
    @POST("uploadData")
    suspend fun uploadData(@Body body: UserDataBody, @Header("Authorization") token: String ): Response<SavedUserDataResponse>
}